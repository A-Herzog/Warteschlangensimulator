...
public class CalcSystem extends CalcSystemBase {
	...
	/**
	 * Liefert eine nicht-negative Pseudo-Zufallszahl gemäß einer Verteilungsfunktion.
	 * Ist ein spezieller Generator hinterlegt, so wird dieser verwendet;
	 * ansonsten wird {@link DistributionRandomNumber} verwendet.
	 * @param distribution	Verteilungsfunktion
	 * @return	Pseudo-Zufallszahl gemäß der angegebenen Verteilung
	 * @see DistributionRandomNumber
	 * @see DistributionRandomNumberThreadLocal
	 */
	...
	/**
	 * Liefert eine Pseudo-Zufallszahl gemäß einer Verteilungsfunktion.
	 * Ist ein spezieller Generator hinterlegt, so wird dieser verwendet;
	 * ansonsten wird {@link DistributionRandomNumber} verwendet.
	 * @param distribution	Verteilungsfunktion
	 * @return	Pseudo-Zufallszahl gemäß der angegebenen Verteilung
