 ...
 */
public class CalcSymbolDistributionUQuadratic extends CalcSymbolDistribution {
	/**
	 ...
	 */
	public CalcSymbolDistributionUQuadratic() {
		/*
	...
	protected AbstractRealDistribution getDistribution(double[] parameters) {
		return new UQuadraticDistribution(parameters[0],parameters[1]);
	}
}
