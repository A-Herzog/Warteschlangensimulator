 ...
 * @version 1.0
 */
public abstract class CalcSymbolDistributionFull extends CalcSymbolPreOperator {
	/**
	 ...
	 */
	public CalcSymbolDistributionFull() {
	 ...
	 * @see CalcSymbolDistributionFull#getDistribution(double[])
	 */
	 ...
	 * @param parameters	Parameter der Verteilung (wie viele Werte hier übergeben werden, kann in {@link CalcSymbolDistributionFull#getParameterCount()} festgelegt werden)
	 ...
	 * @see CalcSymbolDistributionFull#getParameterCount()
	 */
	...
	protected final double calc(double[] parameters) throws MathCalcError {
		...
		if (parameters.length==parameterCount) {
			...
			return calcSystem.getRandom(distribution);
		}
