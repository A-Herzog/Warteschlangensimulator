 ...
 * @version 1.0
 */
public class CalcSymbolDiscreteDistributionNegativeHyperGeom extends CalcSymbolDiscreteDistribution {
	/**
	 * Konstruktor der Klasse
	 */
	public CalcSymbolDiscreteDistributionNegativeHyperGeom() {
		/*
	...
	protected double calcProbability(double[] parameters, int k) {
		...
		try {
			return CalcSymbolPreOperatorBinomial.binomialCoefficient(k-1,n-1)*CalcSymbolPreOperatorBinomial.binomialCoefficient(N-k,K-n)/CalcSymbolPreOperatorBinomial.binomialCoefficient(N,K);
		} catch (Exception e) {
			return -1;
		}
	}
