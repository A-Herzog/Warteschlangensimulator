 ...
 */
public class CalcSymbolDistributionArcsine extends CalcSymbolDistribution {
	/**
	 ...
	 */
	public CalcSymbolDistributionArcsine() {
		/*
	...
	protected AbstractRealDistribution getDistribution(double[] parameters) {
		return new ArcsineDistribution(parameters[0],parameters[1]);
	}
}
