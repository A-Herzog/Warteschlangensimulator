 ...
 */
public class CalcSymbolDistributionMaxwellBoltzmann extends CalcSymbolDistribution {
	/**
	 ...
	 */
	public CalcSymbolDistributionMaxwellBoltzmann() {
		/*
	...
	protected AbstractRealDistribution getDistribution(double[] parameters) {
		...
		return new MaxwellBoltzmannDistribution(parameters[0]);
	}
}
