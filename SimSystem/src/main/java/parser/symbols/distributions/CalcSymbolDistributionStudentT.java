 ...
 */
public final class CalcSymbolDistributionStudentT extends CalcSymbolDistribution {
	/**
	 ...
	 */
	public CalcSymbolDistributionStudentT() {
		/*
	...
	protected AbstractRealDistribution getDistribution(double[] parameters) {
		...
		return new StudentTDistributionImpl(parameters[0],parameters[1]);
	}
}
