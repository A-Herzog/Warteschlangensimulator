 ...
 */
public class CalcSymbolDistributionSine extends CalcSymbolDistribution {
	/**
	 ...
	 */
	public CalcSymbolDistributionSine() {
		/*
	...
	protected AbstractRealDistribution getDistribution(double[] parameters) {
		return new SineDistribution(parameters[0],parameters[1]);
	}
}
