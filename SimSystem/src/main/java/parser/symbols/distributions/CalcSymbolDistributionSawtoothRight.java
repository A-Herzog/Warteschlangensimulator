 ...
 */
public class CalcSymbolDistributionSawtoothRight extends CalcSymbolDistribution {
	/**
	 ...
	 */
	public CalcSymbolDistributionSawtoothRight() {
		/*
	...
	protected AbstractRealDistribution getDistribution(double[] parameters) {
		...
		return new SawtoothRightDistribution(parameters[0],parameters[1]);
	}
}
