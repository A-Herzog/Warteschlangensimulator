...
* System requirements: [Java 8 or higher](https://adoptium.net/ "Download Java from adoptopenjdk.net") (when using a high DPI display, Java 11 or higher is recommended)
