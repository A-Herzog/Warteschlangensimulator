!ifdef LANG_ENGLISH
	...
	LangString MULTIUSER_ALL_USERS ${LANG_ENGLISH} "For &anyone who uses this computer (all users), no automatic update available."
	LangString MULTIUSER_CURRENT_USER ${LANG_ENGLISH} "For &me ({USER}), recommended."
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_ENGLISH} "For anyone who uses this computer (all users), no automatic update available."
	LangString MULTIUSER_CURRENT_USER_UMUI ${LANG_ENGLISH} "For me ({USER}), recommended."
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_ENGLISH} "current user"
!endif
...
!ifdef LANG_AFRIKAANS
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_AFRIKAANS} "current user"
!endif
...
!ifdef LANG_ALBANIAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_ALBANIAN} "current user"
!endif
...
!ifdef LANG_ARABIC
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_ARABIC} "current user"
!endif
...
!ifdef LANG_ARMENIAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_ARMENIAN} "current user"
!endif
...
!ifdef LANG_ASTURIAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_ASTURIAN} "current user"
!endif
...
!ifdef LANG_BASQUE
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_BASQUE} "current user"
!endif
...
!ifdef LANG_BELARUSIAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_BELARUSIAN} "current user"
!endif
...
!ifdef LANG_BOSNIAN
    ...
    LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_BOSNIAN} "current user"	
!endif
...
!ifdef LANG_BRETON
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_BRETON} "current user"
!endif

!ifdef LANG_BULGARIAN
	LangString MULTIUSER_PAGE_TITLE ${LANG_BULGARIAN} "????? ?? ???????????"
	LangString MULTIUSER_INSTALL_PAGE_SUBTITLE ${LANG_BULGARIAN} "???????? ?? ??? ??????????? ?? ?? ????????? $(^NameDA)."
	LangString MULTIUSER_UNINSTALL_PAGE_SUBTITLE ${LANG_BULGARIAN} "???????? ?? ??? ??????????? ?? ?? ???????? $(^NameDA)."
	LangString MULTIUSER_INSTALL_HEADER ${LANG_BULGARIAN} "???????? ???? ?? ??????????? $(^NameDA) ?? ?????? ??????????? ??? ?? ??????? ??????????."
	LangString MULTIUSER_UNINSTALL_HEADER ${LANG_BULGARIAN} "$(^NameDA) ? ?????????? ???????????? ?? ?????? ??????????? ? ?? ??????? ??????????.$\r$\n???????? ??? ?????????? ??????????."
	LangString MULTIUSER_ALL_USERS ${LANG_BULGARIAN} "?? &?????, ????? ???????? ???? ???????? (?????? ???????????)"
	LangString MULTIUSER_CURRENT_USER ${LANG_BULGARIAN} "?? &??? ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_BULGARIAN} "?? ?????, ????? ???????? ???? ???????? (?????? ???????????)"
	LangString MULTIUSER_CURRENT_USER_UMUI ${LANG_BULGARIAN} "?? ??? ({USER})"
	LangString MULTIUSER_NEW_INSTALLATION_ALL_USERS ${LANG_BULGARIAN} "???? ?????????? ?? ?????? ???????????."
	LangString MULTIUSER_NEW_INSTALLATION_CURRENT_USER ${LANG_BULGARIAN} "???? ?????????? ?? ??????? ??????????."
	LangString MULTIUSER_INSTALLED_ALL_USERS ${LANG_BULGARIAN} "?????? {VERSION} ? ??????????? ?? ?????? ??????????? ? $\"{FOLDER}$\"."
	LangString MULTIUSER_INSTALLED_CURRENT_USER ${LANG_BULGARIAN} "?????? {VERSION} ? ?????????? ?? ??????? ?????????? ? $\"{FOLDER}$\"."
	LangString MULTIUSER_REINSTALL_SAME_VERSION_ALL_USERS ${LANG_BULGARIAN} "?????????????? ?? ?????? {VERSION} ?? ?????? ???????????."
	LangString MULTIUSER_REINSTALL_SAME_VERSION_CURRENT_USER ${LANG_BULGARIAN} "?????????????? ?? ?????? {VERSION} ?? ??????? ??????????."
	LangString MULTIUSER_REINSTALL_DIFF_VERSION_ALL_USERS ${LANG_BULGARIAN} "????????????? ?? ?????? {OLD_VERSION} ? ??????????? ?? ?????? {VERSION} ?? ?????? ???????????."
	LangString MULTIUSER_REINSTALL_DIFF_VERSION_CURRENT_USER ${LANG_BULGARIAN} "????????????? ?? ?????? {OLD_VERSION} ? ??????????? ?? ?????? {VERSION} ?? ??????? ??????????."
	LangString MULTIUSER_RUN_AS_ADMIN ${LANG_BULGARIAN} "?????? ?? ?????????? ???? ???????? ???? ?????????????."
	LangString MULTIUSER_ADMIN_CREDENTIALS_REQUIRED ${LANG_BULGARIAN} "??????? ?? ???????????????? ?????????????."
	...
	; error messages - not so important
	LangString MULTIUSER_INVALID_PARAMS ${LANG_BULGARIAN} "????????? ?????????? ?? ?????????."
	LangString MULTIUSER_NOT_INSTALLED ${LANG_BULGARIAN} "???? ?????????? ?? $(^NameDA)."
	LangString MULTIUSER_INSTALLATION_FOR_CURRENT_USER_NOT_SUPPORTED ${LANG_BULGARIAN} "????????????? ??????? ?? ???????? ?????????? ?? ??????? ??????????."
	LangString MULTIUSER_ADMIN_ACCOUNT_LOGIN_REQUIRED ${LANG_BULGARIAN} "?????? ?? ??????? ? ??????, ????? ? ???? ?? ?????????????????? ?????, ?? ?? ??????????."
	LangString MULTIUSER_ELEVATION_NOT_SUPPORTED ${LANG_BULGARIAN} "????????????? ??????? ?? ???????? ?????????? ?? ????????????."
	LangString MULTIUSER_LOGON_SERVICE_NOT_RUNNING ${LANG_BULGARIAN} "?? ? ???????? ?????????? ?? ????????????, ???????? Secondary Logon ?? ? ???????."
	LangString MULTIUSER_ELEVATION_ERROR ${LANG_BULGARIAN} "?? ? ???????? ?????????? ?? ????????????, ?????? {ERROR}."		
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_BULGARIAN} "current user"
!endif
...
!ifdef LANG_CATALAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_CATALAN} "current user"
!endif
...
!ifdef LANG_CORSICAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_CORSICAN} "current user"
!endif
...
!ifdef LANG_CROATIAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_CROATIAN} "current user"
!endif
...
!ifdef LANG_CZECH
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_CZECH} "current user"
!endif
...
!ifdef LANG_DANISH
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_DANISH} "current user"
!endif
...
!ifdef LANG_DUTCH
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_DUTCH} "current user"
!endif
...
!ifdef LANG_ESPERANTO
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_ESPERANTO} "current user"
!endif
...
!ifdef LANG_ESTONIAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_ESTONIAN} "current user"
!endif
...
!ifdef LANG_FARSI
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_FARSI} "current user"
!endif
...
!ifdef LANG_FINNISH
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_FINNISH} "current user"
!endif
...
!ifdef LANG_FRENCH
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_FRENCH} "current user"
!endif
...
!ifdef LANG_GALICIAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_GALICIAN} "current user"
!endif
...
!ifdef LANG_GEORGIAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_GEORGIAN} "current user"
!endif

!ifdef LANG_GERMAN
	; Translation on 2019-03-29 done by: https://github.com/Tobias-B-Besemer
	LangString MULTIUSER_PAGE_TITLE ${LANG_GERMAN} "Installationsart wählen"
	LangString MULTIUSER_INSTALL_PAGE_SUBTITLE ${LANG_GERMAN} "Wie soll $(^NameDA) installiert werden?"
	LangString MULTIUSER_UNINSTALL_PAGE_SUBTITLE ${LANG_GERMAN} "Wie soll $(^NameDA) entfernt werden?"
	LangString MULTIUSER_INSTALL_HEADER ${LANG_GERMAN} "$(^NameDA) kann entweder für den aktuellen Benutzer oder für alle Benutzer dieses Computers installiert werden."
	...
	LangString MULTIUSER_ALL_USERS ${LANG_GERMAN} "Für &jeden, der diesen Computer benutzt (alle Benutzer), nicht automatisch aktualisierbar."
	LangString MULTIUSER_CURRENT_USER ${LANG_GERMAN} "Für &mich ({USER}), empfohlen."
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_GERMAN} "Für jeden, der diesen Computer benutzt (alle Benutzer), nicht automatisch aktualisierbar."
	LangString MULTIUSER_CURRENT_USER_UMUI ${LANG_GERMAN} "Für mich ({USER}), empfohlen."
	LangString MULTIUSER_NEW_INSTALLATION_ALL_USERS ${LANG_GERMAN} "Installation für alle Benutzer."
	LangString MULTIUSER_NEW_INSTALLATION_CURRENT_USER ${LANG_GERMAN} "Installation für den aktuellen Benutzer."
	LangString MULTIUSER_INSTALLED_ALL_USERS ${LANG_GERMAN} "Version {VERSION} ist installiert für alle Benutzer in $\"{FOLDER}$\"."
	LangString MULTIUSER_INSTALLED_CURRENT_USER ${LANG_GERMAN} "Version {VERSION} ist installiert für den aktuellen Benutzer in $\"{FOLDER}$\"."
	LangString MULTIUSER_REINSTALL_SAME_VERSION_ALL_USERS ${LANG_GERMAN} "Neuinstallation Version {VERSION} für alle Benutzer."
	LangString MULTIUSER_REINSTALL_SAME_VERSION_CURRENT_USER ${LANG_GERMAN} "Neuinstallation von Version {VERSION} für aktuellen Benutzer."
	LangString MULTIUSER_REINSTALL_DIFF_VERSION_ALL_USERS ${LANG_GERMAN} "Deinstallation von Version {OLD_VERSION} und Installation von Version {VERSION} für alle Benutzer."
	LangString MULTIUSER_REINSTALL_DIFF_VERSION_CURRENT_USER ${LANG_GERMAN} "Deinstallation von Version {OLD_VERSION} und Installation von Version {VERSION} für den aktuellen Benutzer."
	LangString MULTIUSER_RUN_AS_ADMIN ${LANG_GERMAN} "Das Programm muss als Administrator ausgeführt werden."
	LangString MULTIUSER_ADMIN_CREDENTIALS_REQUIRED ${LANG_GERMAN} "Es werden Administrator-Anmeldedaten benötigt."
	LangString MULTIUSER_ADMIN_UNINSTALL_CREDENTIALS_REQUIRED ${LANG_GERMAN} "Es werden Administrator-Anmeldedaten für die Deinstallation benötigt."
	LangString MULTIUSER_INVALID_PARAMS ${LANG_GERMAN} "Unzulässige Kombination von Parametern."
	LangString MULTIUSER_NOT_INSTALLED ${LANG_GERMAN} "Es ist keine Installation von $(^NameDA) vorhanden."
	LangString MULTIUSER_INSTALLATION_FOR_CURRENT_USER_NOT_SUPPORTED ${LANG_GERMAN} "Die Installation für den aktuellen Nutzer wird vom Betriebssystem nicht zugelassen."
	LangString MULTIUSER_ADMIN_ACCOUNT_LOGIN_REQUIRED ${LANG_GERMAN} "Du musst Dich mit einem Konto, das ein Mitglied der Administratoren Gruppe ist, anmelden um fortzufahren."
	LangString MULTIUSER_ELEVATION_NOT_SUPPORTED ${LANG_GERMAN} "Das Betriebssystem unterstützt keine Hochstuffung."
	LangString MULTIUSER_LOGON_SERVICE_NOT_RUNNING ${LANG_GERMAN} "Hochstuffung ist nicht möglich, zweiter Anmelde-Service läuft nicht."
	LangString MULTIUSER_ELEVATION_ERROR ${LANG_GERMAN} "Hochstuffung ist nicht möglich, Fehler {ERROR}."	
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_GERMAN} "aktueller Nutzer"
!endif
...
!ifdef LANG_GREEK
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_GREEK} "current user"
!endif
...
!ifdef LANG_HEBREW
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_HEBREW} "current user"
!endif
...
!ifdef LANG_HUNGARIAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_HUNGARIAN} "current user"
!endif
...
!ifdef LANG_ICELANDIC
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_ICELANDIC} "current user"
!endif
...
!ifdef LANG_IRISH
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_IRISH} "current user"
!endif
...
!ifdef LANG_ITALIAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_ITALIAN} "current user"
!endif
...
!ifdef LANG_JAPANESE
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_JAPANESE} "current user"
!endif
...
!ifdef LANG_KOREAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_KOREAN} "current user"
!endif
...
!ifdef LANG_KURDISH
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_KURDISH} "current user"
!endif
...
!ifdef LANG_LATVIAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_LATVIAN} "current user"
!endif
...
!ifdef LANG_LITHUANIAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_LITHUANIAN} "current user"
!endif
...
!ifdef LANG_LUXEMBOURGISH
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_LUXEMBOURGISH} "current user"
!endif
...
!ifdef LANG_MACEDONIAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_MACEDONIAN} "current user"
!endif
...
!ifdef LANG_MALAY
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_MALAY} "current user"
!endif
...
!ifdef LANG_MONGOLIAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_MONGOLIAN} "current user"
!endif
...
!ifdef LANG_NORWEGIAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_NORWEGIAN} "current user"
!endif
...
!ifdef LANG_NORWEGIANNYNORSK
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_NORWEGIANNYNORSK} "current user"
!endif
...
!ifdef LANG_PASHTO
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_PASHTO} "current user"
!endif
...
!ifdef LANG_POLISH
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_POLISH} "current user"
!endif
...
!ifdef LANG_PORTUGUESE
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_PORTUGUESE} "current user"
!endif
...
!ifdef LANG_PORTUGUESEBR
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_PORTUGUESEBR} "current user"
!endif
...
!ifdef LANG_ROMANIAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_ROMANIAN} "current user"
!endif
...
!ifdef LANG_RUSSIAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_RUSSIAN} "current user"
!endif
...
!ifdef LANG_SCOTSGAELIC
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_SCOTSGAELIC} "current user"
!endif
...
!ifdef LANG_SERBIAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_SERBIAN} "current user"
!endif
...
!ifdef LANG_SERBIANLATIN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_SERBIANLATIN} "current user"
!endif
...
!ifdef LANG_SIMPCHINESE
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_SIMPCHINESE} "current user"
!endif
...
!ifdef LANG_SLOVAK
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_SLOVAK} "current user"
!endif
...
!ifdef LANG_SLOVENIAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_SLOVENIAN} "current user"
!endif
...
!ifdef LANG_SPANISH
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_SPANISH} "current user"
!endif
...
!ifdef LANG_SPANISHINTERNATIONAL
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_SPANISHINTERNATIONAL} "current user"
!endif
...
!ifdef LANG_SWEDISH
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_SWEDISH} "current user"
!endif
...
!ifdef LANG_TATAR
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_TATAR} "current user"
!endif
...
!ifdef LANG_THAI
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_THAI} "current user"
!endif
...
!ifdef LANG_TRADCHINESE
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_TRADCHINESE} "current user"
!endif
...
!ifdef LANG_TURKISH
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_TURKISH} "current user"
!endif
...
!ifdef LANG_UKRAINIAN
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_UKRAINIAN} "current user"
!endif
...
!ifdef LANG_UZBEK
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_UZBEK} "current user"
!endif
...
!ifdef LANG_VIETNAMESE
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_VIETNAMESE} "current user"
!endif
...
!ifdef LANG_WELSH
	...
	LangString MULTIUSER_CURRENT_USER_UNINSTALL ${LANG_WELSH} "current user"
!endif
