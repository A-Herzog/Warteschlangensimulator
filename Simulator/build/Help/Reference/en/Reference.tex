...
"\texttt{ClientData(1)=5}" or "\texttt{ClientData('key')=TextValue}".
...
\texttt{ClientData(nr)=Formula} or \texttt{ClientData('key')=TextValue}.
...
on a \textbf{schedule} or by a \textbf{release condition}, a \textbf{thresholdvalue} or by
