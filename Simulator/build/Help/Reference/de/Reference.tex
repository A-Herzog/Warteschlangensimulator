...
Es kann eingestellt werden, welche Sound-Datei bzw. welcher System-Sound abgespielt werden soll,
...
Des Weiteren kann eingestellt werden, ob einige besondere HTML- und LaTeX-Symbole (siehe Seite \pageref{ref:TextEntities}) entsprechend
interpretiert werden sollen und ob Formatierungen gemäß der Markdown-Symbole \texttt{\#}, \texttt{\#\#}, \texttt{\#\#\#}, \texttt{*}
und \texttt{**} durchgeführt werden sollen.
