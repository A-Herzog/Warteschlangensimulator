...
Das Mehrfach-Zuweisung-Element weist den Kunden, die es passieren, einen neuen Kundentyp dem sie in der Statistik zugeordnet werden sollen, zu.
Es können dabei verschiedene Kundentypen in Abhängigkeit von konfigurierbaren Bedingungen zugewiesen werden. 

\subsection*{Einstellungen}

Es können beliebig viele Kundentypen angegeben werden und für jeden eine Bedingung, wann diese Zuweisung angewendet werden soll.
...
Die Erfassung kann dabei optional nach Kundentypen und Zeitintervallen ausdifferenziert werden. 
...
Außerdem kann zusätzlich eine intervallbasierte Erfassung aktiviert werden.
In diesem Fall wird pro Intervall (dessen Länge einstellbar ist) für jeden
zeitdiskreten Wert die Anzahl und der Mittelwert der in dem Intervall erfassten Werte
aufgezeichnet. Die Erfassung beginnt mit dem Ende der Einschwingphase.
