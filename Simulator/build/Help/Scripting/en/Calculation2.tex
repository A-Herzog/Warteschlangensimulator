...
\item
\cmd{\§("Key")}:\\
Returns the value from the map which can be accessed by <tt>getMapGlobal()</tt> at scripting elements.
...
\subsection{Number of clients just being served at a station}

\begin{itemize}

\item
\cmd{Process(id)}:\\
Gets the current number of clients just being served at station \cm{id}.
