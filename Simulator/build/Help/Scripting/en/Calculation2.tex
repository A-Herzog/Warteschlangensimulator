...
\begin{itemize}
\item
\cmd{Command(id)}: Query property at station \cm{id} abfragen (across all client types).
\item
\cmd{Command(id)}: Query property for clients generated at source \cm{id} (across all stations).
\item
\cmd{Command(id1;id2)}: Query property at station \cm{id1} for clients generated at source \cm{id2}.
\item
\cmd{Command(id;nr)}: Query property for clients generated at source \cm{id} as record \cm{nr} (1-based) (across all stations).
\item
\cmd{Command(id1;id2;nr)}: Query property at station \cm{id1} for clients generated at source \cm{id2} as record \cm{nr} (1-based).
\end{itemize}
...
\item
\cmd{Counter(id;index)} or \cmd{Value(id;index)}:\\
Gets the value of the counter with 1-based index \cm{index} at multi counter station \cm{id}.

\item
\cmd{Anteil(id;index)} or \cmd{Part(id;index)}:\\
Gets the share of the counter value of the counter with 1-based index \cm{index} in the counter group at multi counter station \cm{id}.
...
Returns the mean value of the differnce counter whose \cm{id} has been specified in the parameter.
...
Returns the maximum value of the differnce counter whose \cm{id} has been specified in the parameter.
...
Returns the minimum value of the differnce counter whose \cm{id} has been specified in the parameter.
...
Returns the standard deviation of the differnce counter whose \cm{id} has been specified in the parameter.
...
\cmd{FlowFactor(id)}:\\
Returns the flow factor at station \cm{id}.
...
\cmd{FlowFactor(id)}:\\
Returns the flow factor of the clients, whos name appears at the source or the type assignment \cm{id} (in seconds).
(alternative parameterization possible)
...
\item
\cmd{resource\_count\_average(id)} or \cmd{resource\_capacity\_average(id)} or \cmd{MR\_average(id)}:\\
...
\item
\cmd{resource\_median(id)} or \cmd{utilization\_median(id)}:\\
Gets the median of the number of busy operators in the specified resource.
  
\item
\cmd{resource\_quantil(id;p)} or \cmd{utilization\_quantil(id;p)}:\\
...
\item
\cmd{resource\_count\_average()} or \cmd{resource\_capacity\_average()} or \cmd{MR\_average()}:\\
...
\item
\cmd{transporter\_median(id)} oder \cmd{transporter\_utilization\_median(id)}:\\
Gets the median of the number of busy operators in the specified resource.
  
\item
\cmd{transporter\_quantil(id;p)} oder \cmd{transporter\_utilization\_quantil(id;p)}:\\
Gets the quantil for the number of busy operators in the specified resource.
...
\item
\cmd{KundeQuelleID()} or \cmd{ClientSourceID()}:\\
