...
\item
\cmd{csch(x)}:
Reciprocal of the sine hyperbolicus
...
\item
\cmd{sech(x)}:
Reciprocal of the cosine hyperbolicus
...
\item
\cmd{BoltzmannDist(k;l;N)}:
Calculates the counting probability density at $k$.

\item
\cmd{BoltzmannDist(l;N)}:
Generates a random number based on this distribution.
...
\item
\cmd{NormalDist(a;b)}:
Generates a non negatuve random number based on this distribution.
...
\section{Inverse gamma distribution with mean \texorpdfstring{$a$}{a} and standard deviation \texorpdfstring{$b$}{b}}

\begin{itemize}

\item
\cmd{InverseGammaDistDirect(x;a;b;0)}:
Calculates the probability density at $x$.

\item
\cmd{InverseGammaDistDirect(x;a;b;1)}:
Calculates the cumulative distribution function at $x$.

\item
\cmd{InverseGammaDistDirect(a;b)}:
Generates a random number based on this distribution.
...
\section{Inverse gaussian distribution with mean \texorpdfstring{$a$}{a} and standard deviation \texorpdfstring{$b$}{b}}

\begin{itemize}

\item
\cmd{InverseGaussianDistDirect(x;a;b;0)}:
Calculates the probability density at $x$.

\item
\cmd{InverseGaussianDistDirect(x;a;b;1)}:
Calculates the cumulative distribution function at $x$.

\item
\cmd{InverseGaussianDistDirect(a;b)}:
Generates a random number based on this distribution.
...
\cmd{PhaseTypeDistRandom(s...;alpha...)}\\
Generates a random number according to a phase-type distribution specified by the matrix s (given row by row) and the vector alpha.
