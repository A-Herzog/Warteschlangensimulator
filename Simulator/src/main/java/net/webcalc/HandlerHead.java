...
/**
 * Dieser Handler Verarbeitet eine http-HEAD Anfrage.
 * @author Alexander Herzog
 * @see CalcWebServer
 */
public class HandlerHead implements WebServerHandler {
	 ...
	 */
	public HandlerHead(final String serverURL, final Function<String,WebServerResponse> process) {
