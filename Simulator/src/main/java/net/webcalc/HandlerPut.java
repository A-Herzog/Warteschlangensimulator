...
/**
 * Dieser Handler Verarbeitet eine http-PUT Anfrage.
 * @author Alexander Herzog
 * @see CalcWebServer
 */
public class HandlerPut implements WebServerHandler {
	 ...
	 */
	public HandlerPut(final String serverURL, final Function<String,WebServerResponse> process) {
	...
	public WebServerResponse process(IHTTPSession session) {
		if (session.getMethod()!=NanoHTTPD.Method.PUT) return null;
