...
public class Simulator extends SimulatorBase implements AnySimulator {
	...
	protected Statistics collectStatistics() {
		...
		if (threads.length==1) {
			...
			statistics=new Statistics(runModel.correlationRange,runModel.correlationMode,runModel.correlationRangeStepping,runModel.batchMeansSize,runModel.collectWaitingTimes,runModel.distributionRecordHours,runModel.stateRecordSize,runModel.distributionRecordClientDataValues,runModel.useWelford);
	...
	public Statistics getIncompleteStatistic() {
		...
		final Statistics statistics=new Statistics(runModel.correlationRange,runModel.correlationMode,runModel.correlationRangeStepping,runModel.batchMeansSize,runModel.collectWaitingTimes,runModel.distributionRecordHours,runModel.stateRecordSize,runModel.distributionRecordClientDataValues,runModel.useWelford);
		writeBaseDataToStatistics(statistics);
