...
/**
 * Kunde gibt das Warten and eine Ressource-Belegen-Station auf
 * @author Alexander Herzog
 */
public class SeizeWaitingCancelEvent extends Event {
	/**
	 ...
	 */
	public RunElementSeize station;

	/**
	 * Konstruktor der Klasse
	 */
	public SeizeWaitingCancelEvent() {
		/*
