...
/**
 * Laufzeitdaten eines {@link RunElementAssignMultiBase}-Laufzeit-Objekts
 * @author Alexander Herzog
 * @see RunElementAssignMultiBase
 * @see RunElementData
 */
public class RunElementAssignMultiBaseData extends RunElementData {
	/**
	 ...
	 */
	public RunElementAssignMultiBaseData(final RunElement station, final String condition, final String[] variableNames, final SimulationData simData) {
