...
/**
 * Laufzeitdaten eines {@link RunElementTeleportDecideByChance}-Laufzeit-Objekts
 * @author Alexander Herzog
 * @see RunElementTeleportDecideByChance
 * @see RunElementData
 */
public class RunElementTeleportDecideByChanceData extends RunElementData {
	 ...
	 */
	public RunElementTeleportDecideByChanceData(final RunElement station, final String[] rates, final String[] variableNames, final SimulationData simData) {
