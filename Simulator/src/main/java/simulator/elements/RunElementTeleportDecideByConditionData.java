...
public class RunElementTeleportDecideByConditionData extends RunElementData {
	 ...
	 */
	public RunElementTeleportDecideByConditionData(final RunElement station, final String[] conditions, final String[] variableNames, final SimulationData simData) {
