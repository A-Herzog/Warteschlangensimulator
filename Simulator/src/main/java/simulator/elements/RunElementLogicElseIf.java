...
/**
 * Äquivalent zu <code>ModelElementLogicIfElse</code>
	...
	public void processLeave(final SimulationData simData, final RunDataClient client) {
		if (!client.testLogic()) {
			...
			if (checkCondition(simData,client)) {
				/* Bedingung erfüllt, ElseIf-Zweig ausführen */
				...
				/* Bedingung nicht erfüllt, ElseIf-Zweig überspringen */
			...
			/* If-Zweig wurde schon ausgeführt, ElseIf-Zweig überspringen */
