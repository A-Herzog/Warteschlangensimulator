...
/**
 * Laufzeitdaten eines {@link RunElementAnimationPause}-Laufzeit-Objekts
 * @author Alexander Herzog
 * @see RunElementAnimationPause
 * @see RunElementData
 */
public class RunElementAnimationPauseData extends RunElementData {
	/**
	...
	/**
	 * Ist die Funktion überhaupt noch aktiv?
	 */
