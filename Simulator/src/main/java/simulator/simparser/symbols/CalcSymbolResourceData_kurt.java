...
/**
 * Liefert den Exzess der Anzahl an belegten Bedienern in der angegebenen Ressource (1. Parameter).
 * @author Alexander Herzog
 */
public class CalcSymbolResourceData_kurt extends CalcSymbolResourceData {
	/**
