 ...
 * (a) Liefert die minimale Anzahl an wartenden Kunden, deren Name an Quelle bzw. Namenszuweisung id (1. Parameter) auftritt.<br>
 * (b) Liefert die minimale Anzahl an Kunden in der Warteschlange an Station id (1. Parameter).<br>
 * Im Falle von keinem Parameter:<br>
 * Liefert die minimale Anzahl an Kunden in allen Warteschlange zusammen.
...
public class CalcSymbolStationDataQueue_min extends CalcSymbolStationData {
	 ...
	 */
	public CalcSymbolStationDataQueue_min() {
		/*
	...
	protected double calcAll() {
		return getSimData().statistics.clientsInSystemQueues.getTimeMin();
	}
	...
	protected double calc(final RunElementData data) {
		...
		return data.statisticClientsAtStationQueue.getTimeMin();
	}
	...
	protected double calcStationClient(final RunElementData data, final int clientTypeIndex) {
		...
		return data.statisticClientsAtStationQueueByClientType[clientTypeIndex].getTimeMin();
	}
}