 ...
 * (a) Liefert den Median der Verweilzeiten der Kunden, deren Name an Quelle bzw. Namenszuweisung id (1. Parameter) auftritt (in Sekunden).<br>
 * (b) Liefert den Median der Verweilzeiten der Kunden an Station id (1. Parameter) (in Sekunden).<br>
...
public class CalcSymbolStationDataResidence_median extends CalcSymbolStationData {
	 ...
	 */
	public CalcSymbolStationDataResidence_median() {
		/*
	...
	protected double calc(final RunElementData data) {
		...
		return data.statisticResidence.getMedian();
	}
	...
	protected double calcAll() {
		return getSimData().statistics.clientsAllResidenceTimes.getMedian();
	}
	...
	protected double calcStationClient(final RunElementData data, final int clientTypeIndex) {
		...
		return data.statisticResidenceByClientType[clientTypeIndex].getMedian();
	}
}
