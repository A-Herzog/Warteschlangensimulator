 ...
 * (a) Liefert die minimale Anzahl an Kunden in Bedienung, deren Name an Quelle bzw. Namenszuweisung id (1. Parameter) auftritt.<br>
 * (b) Liefert die minimale Anzahl an Kunden in Bedienung an Station id (1. Parameter).<br>
 * Im Falle von keinem Parameter:<br>
 * Liefert die minimale Anzahl an Kunden in allen Warteschlange zusammen.
 * @author Alexander Herzog
 */
public class CalcSymbolStationDataProcessCount_min extends CalcSymbolStationData {
	/**
	...
	protected double calc(final RunElementData data) {
		...
		return data.statisticClientsAtStationProcess.getTimeMin();
	}
	...
	protected double calcStationClient(final RunElementData data, final int clientTypeIndex) {
		...
		return data.statisticClientsAtStationProcessByClientType[clientTypeIndex].getTimeMin();
	}
}