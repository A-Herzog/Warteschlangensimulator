 ...
 * (a) Liefert den Exzess der Transferzeiten der Kunden, deren Name an Quelle bzw. Namenszuweisung id (1. Parameter) auftritt.<br>
 * (b) Liefert den Exzess der Transferzeiten der Kunden an Station id (1. Parameter).<br>
 * Im Falle von keinem Parameter:<br>
 * Liefert den Exzess der Transferzeiten über alle Kunden.
 * @author Alexander Herzog
 */
public class CalcSymbolStationDataTransfer_kurt extends CalcSymbolStationData {
	/**
	...
	protected double calc(final RunElementData data) {
		...
		return data.statisticTransfer.getKurt();
	}
	...
	protected double calcAll() {
		return getSimData().statistics.clientsAllTransferTimes.getKurt();
	}
	...
	protected double calcStationClient(final RunElementData data, final int clientTypeIndex) {
		...
		return data.statisticTransferByClientType[clientTypeIndex].getKurt();
	}
}
