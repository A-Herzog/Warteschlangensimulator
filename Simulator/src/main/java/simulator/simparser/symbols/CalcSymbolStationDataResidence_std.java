 ...
 * (a) Liefert die Standardabweichung der Verweilzeiten der Kunden, deren Name an Quelle bzw. Namenszuweisung id (1. Parameter) auftritt (bezogen auf Sekunden).<br>
 * (b) Liefert die Standardabweichung der Verweilzeiten der Kunden an Station id (1. Parameter) (bezogen auf Sekunden).<br>
...
public class CalcSymbolStationDataResidence_std extends CalcSymbolStationData {
	...
	protected double calc(final RunElementData data) {
		...
		return data.statisticResidence.getSD();
	}
	...
	protected double calcAll() {
		return getSimData().statistics.clientsAllResidenceTimes.getSD();
	}
