 ...
 * (a) Liefert die Schiefe der Bedienzeiten der Kunden, deren Name an Quelle bzw. Namenszuweisung id (1. Parameter) auftritt.<br>
 * (b) Liefert die Schiefe der Bedienzeiten der Kunden an Station id (1. Parameter).<br>
 * Im Falle von keinem Parameter:<br>
 * Liefert die Schiefe der Bedienzeiten über alle Kunden.
 * @author Alexander Herzog
 */
public class CalcSymbolStationDataProcess_sk extends CalcSymbolStationData {
	/**
	...
	protected double calc(final RunElementData data) {
		...
		return data.statisticProcess.getSk();
	}
	...
	protected double calcAll() {
		return getSimData().statistics.clientsAllProcessingTimes.getSk();
	}
	...
	protected double calcStationClient(final RunElementData data, final int clientTypeIndex) {
		...
		return data.statisticProcessByClientType[clientTypeIndex].getSk();
	}
}
