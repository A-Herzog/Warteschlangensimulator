...
/**
 * Liefert den Maximalwert des Differentzählerwertes an Station id.<br>
...
public class CalcSymbolSimDataCounterMax extends CalcSymbolStationData {
	 ...
	 * @see #getNames()
	 */
	private static final String[] names=new String[]{"Zähler_Maximum","Zähler_Max","Counter_Maximum","Counter_Max","Value_Maximum","Value_Max","Wert_Maximum","Wert_Max"};
