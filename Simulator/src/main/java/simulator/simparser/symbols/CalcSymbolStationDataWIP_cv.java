 ...
 * (a) Liefert den Variationskoeffizienten der Anzahl an Kunden, deren Name an Quelle bzw. Namenszuweisung id (1. Parameter) auftritt.<br>
 * (b) Liefert den Variationskoeffizienten der Anzahl an Kunden an Station id (1. Parameter).<br>
...
public class CalcSymbolStationDataWIP_cv extends CalcSymbolStationData {
	...
	protected double calcAll() {
		return getSimData().statistics.clientsInSystem.getTimeCV();
	}
	...
	protected double calc(final RunElementData data) {
		...
		return data.statisticClientsAtStation.getTimeCV();
	}
}