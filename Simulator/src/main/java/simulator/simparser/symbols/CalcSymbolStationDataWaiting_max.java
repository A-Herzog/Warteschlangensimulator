 ...
 * (a) Liefert die maximale Wartezeit der Kunden, deren Name an Quelle bzw. Namenszuweisung id (1. Parameter) auftritt (in Sekunden).<br>
 * (b) Liefert die maximale Wartezeit der Kunden an Station id (1. Parameter) (in Sekunden).<br>
...
public class CalcSymbolStationDataWaiting_max extends CalcSymbolStationData {
	 ...
	 */
	public CalcSymbolStationDataWaiting_max() {
		/*
	...
	protected double calc(final RunElementData data) {
		...
		return data.statisticWaiting.getMax();
	}
	...
	protected double calcAll() {
		return getSimData().statistics.clientsAllWaitingTimes.getMax();
	}
	...
	protected double calcStationClient(final RunElementData data, final int clientTypeIndex) {
		...
		return data.statisticWaitingByClientType[clientTypeIndex].getMax();
	}
}
