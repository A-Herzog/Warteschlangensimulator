 ...
 * (a) Liefert die minimale Anzahl an Kunden, deren Name an Quelle bzw. Namenszuweisung id (1. Parameter) auftritt.<br>
 * (b) Liefert die minimale Anzahl an Kunden an Station id (1. Parameter).<br>
...
public class CalcSymbolStationDataWIP_min extends CalcSymbolStationData {
	 ...
	 */
	public CalcSymbolStationDataWIP_min() {
		/*
	...
	protected double calcAll() {
		return getSimData().statistics.clientsInSystem.getTimeMin();
	}
