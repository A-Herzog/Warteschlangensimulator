...
public final class RunModelCreator {
	...
	private static void addTemplates() {
		...
		templates.add(new RunElementTeleportDecideByChance(null));
		templates.add(new RunElementTeleportDecideByCondition(null));
		templates.add(new RunElementTeleportDecideByClientType(null));
		templates.add(new RunElementTeleportDecideBySequence(null));
		templates.add(new RunElementTeleportDecideByStation(null));
		templates.add(new RunElementTeleportDecideByKeyValue(null));
