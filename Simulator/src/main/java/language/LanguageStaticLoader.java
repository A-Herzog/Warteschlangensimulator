...
public class LanguageStaticLoader {
	...
	public static void setLanguage() {
		...
		Table.FileTypeMD=Language.tr("FileType.MarkdownTable");
		...
		JDataDistributionEditPanel.ButtonUp=Language.tr("JDistributionEditor.ButtonUp");
		JDataDistributionEditPanel.ButtonDown=Language.tr("JDistributionEditor.ButtonDown");
		...
		AnimationImageSource.iconAvatarFemaleGirl1=Language.tr("Animation.Icon.AvatarFemaleGirl1");
		AnimationImageSource.iconAvatarFemaleGirl2=Language.tr("Animation.Icon.AvatarFemaleGirl2");
		AnimationImageSource.iconAvatarFemaleGirl3=Language.tr("Animation.Icon.AvatarFemaleGirl3");
		AnimationImageSource.iconAvatarFemaleGirl4=Language.tr("Animation.Icon.AvatarFemaleGirl4");
		AnimationImageSource.iconAvatarFemaleGirl5=Language.tr("Animation.Icon.AvatarFemaleGirl5");
		AnimationImageSource.iconAvatarBoyMale1=Language.tr("Animation.Icon.AvatarBoyMale1");
		AnimationImageSource.iconAvatarBoyMale2=Language.tr("Animation.Icon.AvatarBoyMale2");
		AnimationImageSource.iconAvatarBoyMale3=Language.tr("Animation.Icon.AvatarBoyMale3");
		AnimationImageSource.iconAvatarBoyMale4=Language.tr("Animation.Icon.AvatarBoyMale4");
		AnimationImageSource.iconAvatarBoyMale5=Language.tr("Animation.Icon.AvatarBoyMale5");
		AnimationImageSource.iconReward=Language.tr("Animation.Icon.Reward");
		AnimationImageSource.iconTarget=Language.tr("Animation.Icon.Target");
		AnimationImageSource.iconSavings=Language.tr("Animation.Icon.Savings");
		AnimationImageSource.iconDirection=Language.tr("Animation.Icon.Direction");
		AnimationImageSource.iconTestTube=Language.tr("Animation.Icon.TestTube");
		AnimationImageSource.iconPieChart=Language.tr("Animation.Icon.PieChart");
		AnimationImageSource.iconContract=Language.tr("Animation.Icon.Contract");
		AnimationImageSource.iconHourGlass=Language.tr("Animation.Icon.HourGlass");
		AnimationImageSource.iconSafe=Language.tr("Animation.Icon.Safe");
		AnimationImageSource.iconPerformanceIncrease=Language.tr("Animation.Icon.PerformanceIncrease");
		AnimationImageSource.iconSalesman=Language.tr("Animation.Icon.Salesman");
		AnimationImageSource.iconMagnet=Language.tr("Animation.Icon.Magnet");
		AnimationImageSource.iconPerformanceDecline=Language.tr("Animation.Icon.PerformanceDecline");
		AnimationImageSource.iconHandshake=Language.tr("Animation.Icon.Handshake");
		AnimationImageSource.iconDataTrends=Language.tr("Animation.Icon.DataTrends");
		AnimationImageSource.iconCompany=Language.tr("Animation.Icon.Company");
		AnimationImageSource.iconCalculator=Language.tr("Animation.Icon.Calculator");
		AnimationImageSource.iconHotAirBalloon=Language.tr("Animation.Icon.HotAirBalloon");
		AnimationImageSource.iconAirplane=Language.tr("Animation.Icon.Airplane");
		AnimationImageSource.iconSailboat=Language.tr("Animation.Icon.Sailboat");
		AnimationImageSource.iconBus=Language.tr("Animation.Icon.Bus");
		AnimationImageSource.iconShipCruise=Language.tr("Animation.Icon.ShipCruise");
		AnimationImageSource.iconHelicopter=Language.tr("Animation.Icon.Helicopter");
		AnimationImageSource.iconShipFreight=Language.tr("Animation.Icon.ShipFreight");
		AnimationImageSource.iconForkliftTruck=Language.tr("Animation.Icon.ForkliftTruck");
		AnimationImageSource.iconBike=Language.tr("Animation.Icon.Bike");
		AnimationImageSource.iconScooter=Language.tr("Animation.Icon.Scooter");
		AnimationImageSource.iconTrain=Language.tr("Animation.Icon.Train");
		AnimationImageSource.iconFuelPump=Language.tr("Animation.Icon.FuelPump");
		AnimationImageSource.iconBufferStop=Language.tr("Animation.Icon.BufferStop");
		AnimationImageSource.iconRocket=Language.tr("Animation.Icon.Rocket");
		AnimationImageSource.iconTrafficLights=Language.tr("Animation.Icon.TrafficLights");
		AnimationImageSource.iconTram=Language.tr("Animation.Icon.Tram");
