...
/**
 * Dialog, der Einstellungen für ein {@link ModelElementSectionStart}-Element anbietet
...
public class ModelElementSectionStartDialog extends ModelElementBaseDialog {
	 ...
	 * @param element	Zu bearbeitendes {@link ModelElementSectionStart}
	 * @param readOnly	Wird dieser Parameter auf <code>true</code> gesetzt, so wird die "Ok"-Schaltfläche deaktiviert
	 */
	public ModelElementSectionStartDialog(final Component owner, final ModelElementSectionStart element, final boolean readOnly) {
	...
	protected String getInfoPanelID() {
		return InfoPanel.stationSectionStart;
	}
