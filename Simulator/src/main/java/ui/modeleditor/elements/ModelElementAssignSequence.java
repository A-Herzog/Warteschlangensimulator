...
/**
 * Zuweisung eines Fertigungsplans
...
public class ModelElementAssignSequence extends ModelElementMultiInSingleOutBox  {
	...
	/**
	 * Konstruktor der Klasse <code>ModelElementAssignSequence</code>
	 * @param model	Modell zu dem dieses Element gehören soll (kann später nicht mehr geändert werden)
	 * @param surface	Zeichenfläche zu dem dieses Element gehören soll (kann später nicht mehr geändert werden)
	 */
	public ModelElementAssignSequence(final EditModel model, final ModelSurface surface) {
	...
	public String getToolTip() {
		return Language.tr("Surface.AssignSequence.Tooltip");
	}

	/**
	 * Liefert den aktuell für diese Zuweisung eingestellten Fertigungsplan
	...
	/**
	 * Stellt einen Fertigungsplan für diese Zuweisung ein
	 * @param sequence	Fertigungsplan
	 */
	...
	public boolean equalsModelElement(ModelElement element) {
		...
		if (!(element instanceof ModelElementAssignSequence)) return false;

		if (!sequence.equals(((ModelElementAssignSequence)element).sequence)) return false;
	...
	public void copyDataFrom(ModelElement element) {
		...
		if (element instanceof ModelElementAssignSequence) {
			sequence=((ModelElementAssignSequence)element).sequence;
		}
	}
	 ...
	 */
	@Override
	public ModelElementAssignSequence clone(final EditModel model, final ModelSurface surface) {
		final ModelElementAssignSequence element=new ModelElementAssignSequence(model,surface);
	...
	public String getContextMenuElementName() {
		return Language.tr("Surface.AssignSequence.Name");
	}
	...
	public String getTypeName() {
		return Language.tr("Surface.AssignSequence.Name.Short");
	}
	...
	public Runnable getProperties(final Component owner, final boolean readOnly, final ModelClientData clientData, final ModelSequences sequences) {
		return ()->{
			new ModelElementAssignSequenceDialog(owner,ModelElementAssignSequence.this,readOnly,sequences);
		};
	}
	...
	public String[] getXMLNodeNames() {
		return Language.trAll("Surface.AssignSequence.XML.Root");
	}
	...
	protected void addPropertiesDataToXML(final Document doc, final Element node) {
		...
		Element sub;
		node.appendChild(sub=doc.createElement(Language.trPrimary("Surface.AssignSequence.XML.Sequence")));
		sub.setTextContent(sequence);
	}
	...
	protected String loadProperty(final String name, final String content, final Element node) {
		...
		if (Language.trAll("Surface.AssignSequence.XML.Sequence",name)) {
			sequence=content;
			return null;
		}
	...
	public String getHelpPageName() {
		return "ModelElementAssignSequence";
	}
