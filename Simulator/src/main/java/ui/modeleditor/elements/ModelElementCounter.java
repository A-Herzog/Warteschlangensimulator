...
public class ModelElementCounter extends ModelElementMultiInSingleOutBox {
	...
	public Icon getAddElementIcon() {
		return Images.MODELEDITOR_ELEMENT_COUNTER.getIcon();
	}
	...
	public String getToolTip() {
		return Language.tr("Surface.Counter.Tooltip");
	}
	 ...
	 */
	@Override
	public ModelElementCounter clone(final EditModel model, final ModelSurface surface) {
		final ModelElementCounter element=new ModelElementCounter(model,surface);
	...
	public String getContextMenuElementName() {
		return Language.tr("Surface.Counter.Name");
	}
	...
	public String getTypeName() {
		return Language.tr("Surface.Counter.Name.Short");
	}
	...
	public Runnable getProperties(final Component owner, final boolean readOnly, final ModelClientData clientData, final ModelSequences sequences) {
		return ()->{
			new ModelElementCounterDialog(owner,ModelElementCounter.this,readOnly);
		};
	}
	...
	protected void addLongRunStatisticsContextMenuItems(final JMenu parentMenu, final Consumer<String> addLongRunStatistics) {
		...
		addLongRunStatisticsMenuItem(parentMenu,addLongRunStatistics,LongRunStatisticsType.COUNTER_PART);
	}
	...
	public String[] getXMLNodeNames() {
		return Language.trAll("Surface.Counter.XML.Root");
	}
	...
	protected String getIDInfo() {
		if (groupName!=null && !groupName.isEmpty()) {
			return super.getIDInfo()+", "+Language.tr("Surface.Counter.Dialog.GroupName.Short")+"="+groupName;
		} else {
