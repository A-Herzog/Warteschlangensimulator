...
/**
 * Implementiert ein Element dieses Interface, so bedeutet dies,
 * dass das gesamte Modell nicht auf einem entfernten Rechner simuliert werden
 * kann und auch nicht parallelisiert werden kann (z.B. weil Datei- oder Datenbank-Ein/Ausgaben erfolgen).
 * @author Alexander Herzog
 */
public interface ElementNoRemoteSimulation {
	/**
