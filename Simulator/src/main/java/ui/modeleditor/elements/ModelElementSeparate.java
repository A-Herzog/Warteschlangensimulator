...
/**
 * Löst einen temporären Batch auf.<br>
 * Alle anderen Kunden passieren das Element ohne Änderung.
 ...
 */
public class ModelElementSeparate extends ModelElementMultiInSingleOutBox {
	/**
	 * Konstruktor der Klasse <code>ModelElementSeparate</code>
	 * @param model	Modell zu dem dieses Element gehören soll (kann später nicht mehr geändert werden)
	 * @param surface	Zeichenfläche zu dem dieses Element gehören soll (kann später nicht mehr geändert werden)
	 */
	public ModelElementSeparate(final EditModel model, final ModelSurface surface) {
	...
	public Icon getAddElementIcon() {
		return Images.MODELEDITOR_ELEMENT_SEPARATE.getIcon();
	}
	...
	public String getToolTip() {
		return Language.tr("Surface.Separate.Tooltip");
	}
	...
	public boolean equalsModelElement(ModelElement element) {
		...
		if (!(element instanceof ModelElementSeparate)) return false;
	 ...
	 */
	@Override
	public ModelElementSeparate clone(final EditModel model, final ModelSurface surface) {
		final ModelElementSeparate element=new ModelElementSeparate(model,surface);
	...
	public String getContextMenuElementName() {
		return Language.tr("Surface.Separate.Name");
	}
	...
	public Runnable getProperties(final Component owner, final boolean readOnly, final ModelClientData clientData, final ModelSequences sequences) {
		return ()->{
			new ModelElementSeparateDialog(owner,ModelElementSeparate.this,readOnly);
		};
	}
	...
	public String[] getXMLNodeNames() {
		return Language.trAll("Surface.Separate.XML.Root");
	}
