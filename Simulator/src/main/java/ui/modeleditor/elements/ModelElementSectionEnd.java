...
/**
 * Ende eines Abschnitts (zur Erfassung wie viele Kunden sich wie
...
public class ModelElementSectionEnd extends ModelElementMultiInSingleOutBox {
	...
	/**
	 * Konstruktor der Klasse <code>ModelElementSectionEnd</code>
	 * @param model	Modell zu dem dieses Element gehören soll (kann später nicht mehr geändert werden)
	 * @param surface	Zeichenfläche zu dem dieses Element gehören soll (kann später nicht mehr geändert werden)

	 */
	public ModelElementSectionEnd(final EditModel model, final ModelSurface surface) {
	...
	public Icon getAddElementIcon() {
		return Images.MODELEDITOR_ELEMENT_SECTION_END.getIcon();
	}
	...
	public String getToolTip() {
		return Language.tr("Surface.SectionEnd.Tooltip");
	}
	...
	public boolean equalsModelElement(ModelElement element) {
		...
		if (!(element instanceof ModelElementSectionEnd)) return false;

		if (!sectionStartName.equals(((ModelElementSectionEnd)element).sectionStartName)) return false;
		return true;
	}
	...
	public void copyDataFrom(ModelElement element) {
		...
		if (element instanceof ModelElementSectionEnd) {
			sectionStartName=((ModelElementSectionEnd)element).sectionStartName;
		}
	}
	 ...
	 */
	@Override
	public ModelElementSectionEnd clone(final EditModel model, final ModelSurface surface) {
		final ModelElementSectionEnd element=new ModelElementSectionEnd(model,surface);
	...
	public String getContextMenuElementName() {
		return Language.tr("Surface.SectionEnd.Name");
	}
	...
	public Runnable getProperties(final Component owner, final boolean readOnly, final ModelClientData clientData, final ModelSequences sequences) {
		return ()->{
			new ModelElementSectionEndDialog(owner,ModelElementSectionEnd.this,readOnly);
		};
	}
	...
	public String[] getXMLNodeNames() {
		return Language.trAll("Surface.SectionEnd.XML.Root");
	}
	...
	protected void addPropertiesDataToXML(final Document doc, final Element node) {
		...
		if (sectionStartName!=null && !sectionStartName.isEmpty()) {
			node.appendChild(sub=doc.createElement(Language.trPrimary("Surface.SectionEnd.XML.SectionStartName")));
	...
	protected String loadProperty(final String name, final String content, final Element node) {
		...
		if (Language.trAll("Surface.SectionEnd.XML.SectionStartName",name)) {
