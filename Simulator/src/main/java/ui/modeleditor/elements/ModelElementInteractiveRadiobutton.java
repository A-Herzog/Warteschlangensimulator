...
/**
 * Radiobutton, über den während der Animation eine Variable auf einen bestimmten,
 * vorab definierten Werte gestellt werden kann. Durch die Verwendung derselben
 * Variable können mehrere Radiobuttons zusammenarbeiten.<br>
...
public class ModelElementInteractiveRadiobutton extends ModelElementPosition implements ElementWithAnimationDisplay, ElementWithNewVariableNames, ElementAnimationClickable, InteractiveElement {
	...
	private void triggerAction(final SimulationData simData, final boolean processDirect) {
		final RunElementInteractiveRadiobutton runElement=(RunElementInteractiveRadiobutton)simData.runModel.elementsFast[getId()];
