...
/**
 * Löst in Abhängigkeit vom verschiedenen Bedingungen verschiedene Aktionen aus
...
public class ModelElementAction extends ModelElementBox implements ModelElementSignalTrigger, ElementWithNewVariableNames {
	...
	/**
	 * Liefert die Liste mit allen Bedingungen und auszulösenden Aktionen
	 * @return	Liste mit allen Bedingungen und auszulösenden Aktionen
	 * @see ModelElementActionRecord
	 */
