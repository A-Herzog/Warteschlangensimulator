...
/**
 * Zuweisung einer Texteigenschaft an einen Kunden
...
public class ModelElementAssignString extends ModelElementMultiInSingleOutBox {
	...
	public Icon getAddElementIcon() {
		return Images.MODELEDITOR_ELEMENT_ASSIGN_STRING.getIcon();
	}
	...
	public String getToolTip() {
		return Language.tr("Surface.AssignString.Tooltip");
	}
	 ...
	 */
	public ModelElementAssignStringRecord getRecord() {
		return record;
	}
	 ...
	 */
	@Override
	public ModelElementAssignString clone(final EditModel model, final ModelSurface surface) {
		final ModelElementAssignString element=new ModelElementAssignString(model,surface);
	...
	public Runnable getProperties(final Component owner, final boolean readOnly, final ModelClientData clientData, final ModelSequences sequences) {
		return ()->{
			new ModelElementAssignStringDialog(owner,ModelElementAssignString.this,readOnly);
		};
	}
	...
	public String[] getXMLNodeNames() {
		return Language.trAll("Surface.AssignString.XML.Root");
	}
	...
	public String getHelpPageName() {
		return "ModelElementAssignString";
	}
