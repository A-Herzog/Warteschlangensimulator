...
/**
 * Löst ein Signal aus, wenn sich ein Kunde durch das Element bewegt
...
public class ModelElementSignal extends ModelElementMultiInSingleOutBox implements ModelElementSignalTrigger {
	...
	public String getToolTip() {
		return Language.tr("Surface.Signal.Tooltip");
	}
	 ...
	 */
	@Override
	public ModelElementSignal clone(final EditModel model, final ModelSurface surface) {
		final ModelElementSignal element=new ModelElementSignal(model,surface);
	...
	public Runnable getProperties(final Component owner, final boolean readOnly, final ModelClientData clientData, final ModelSequences sequences) {
		return ()->{
			new ModelElementSignalDialog(owner,ModelElementSignal.this,readOnly);
		};
	}
	...
	public String[] getXMLNodeNames() {
		return Language.trAll("Surface.Signal.XML.Root");
	}
