...
public class ModelElementSetJS extends ModelElementMultiInSingleOutBox implements ElementWithScript {
	...
	/**
	 * Konstruktor der Klasse <code>ModelElementSetJS</code>
	 * @param model	Modell zu dem dieses Element gehören soll (kann später nicht mehr geändert werden)
	 * @param surface	Zeichenfläche zu dem dieses Element gehören soll (kann später nicht mehr geändert werden)
	 */
	public ModelElementSetJS(final EditModel model, final ModelSurface surface) {
	...
	public Icon getAddElementIcon() {
		return Images.MODELEDITOR_ELEMENT_SET_JS.getIcon();
	}
	...
	public String getToolTip() {
		return Language.tr("Surface.SetJS.Tooltip");
	}
	...
	public boolean equalsModelElement(ModelElement element) {
		...
		if (!(element instanceof ModelElementSetJS)) return false;

		if (!((ModelElementSetJS)element).script.equals(script)) return false;
		if (((ModelElementSetJS)element).mode!=mode) return false;
	...
	public void copyDataFrom(ModelElement element) {
		...
		if (element instanceof ModelElementSetJS) {
			script=((ModelElementSetJS)element).script;
			mode=((ModelElementSetJS)element).mode;
		}
	}
	 ...
	 */
	@Override
	public ModelElementSetJS clone(final EditModel model, final ModelSurface surface) {
		final ModelElementSetJS element=new ModelElementSetJS(model,surface);
	...
	public Runnable getProperties(final Component owner, final boolean readOnly, final ModelClientData clientData, final ModelSequences sequences) {
		return ()->{
			new ModelElementSetJSDialog(owner,ModelElementSetJS.this,readOnly);
		};
	}
	...
	public String[] getXMLNodeNames() {
		return Language.trAll("Surface.SetJS.XML.Root");
	}
	...
	protected void addPropertiesDataToXML(final Document doc, final Element node) {
		...
		Element sub;
		node.appendChild(sub=doc.createElement(Language.trPrimary("Surface.SetJS.XML.Script")));
		switch (mode) {
		case Java:
			sub.setAttribute(Language.trPrimary("Surface.SetJS.XML.Script.Language"),Language.trPrimary("Surface.SetJS.XML.Script.Java"));
			break;
		case Javascript:
			sub.setAttribute(Language.trPrimary("Surface.SetJS.XML.Script.Language"),Language.trPrimary("Surface.SetJS.XML.Script.Javascript"));
			break;
		}
	...
	protected String loadProperty(final String name, final String content, final Element node) {
		...
		if (Language.trAll("Surface.SetJS.XML.Script",name)) {
			script=content;
			final String langName=Language.trAllAttribute("Surface.SetJS.XML.Script.Language",node);
			if (Language.trAll("Surface.SetJS.XML.Script.Java",langName)) mode=ScriptMode.Java;
			if (Language.trAll("Surface.SetJS.XML.Script.Javascript",langName)) mode=ScriptMode.Javascript;
			return null;
		}
