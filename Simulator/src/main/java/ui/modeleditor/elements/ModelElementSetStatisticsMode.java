...
public class ModelElementSetStatisticsMode extends ModelElementMultiInSingleOutBox {
	...
	public Icon getAddElementIcon() {
		return Images.MODELEDITOR_ELEMENT_SET_STATISTICS_MODE.getIcon();
	}
	...
	public void search(final FullTextSearch searcher) {
		...
		searcher.testString(this,Language.tr("Surface.SetStatisticsMode.Dialog.Condition"),condition,newCondition->{condition=newCondition;});
	}
}
