 ...
 */
public class ModelElementTransportDestination extends ModelElementBox implements ModelElementEdgeOut {
	/**
	 * Auslaufende Kante
	 */
	...
	/**
	 * Konstruktor der Klasse <code>ModelElementTransportDestination</code>
	 * @param model	Modell zu dem dieses Element gehören soll (kann später nicht mehr geändert werden)
	 * @param surface	Zeichenfläche zu dem dieses Element gehören soll (kann später nicht mehr geändert werden)
	 */
	public ModelElementTransportDestination(final EditModel model, final ModelSurface surface) {
	...
	public Icon getAddElementIcon() {
		return Images.MODELEDITOR_ELEMENT_TRANSPORT_DESTINATION.getIcon();
	}
	...
	public String getToolTip() {
		return Language.tr("Surface.TransportDestination.Tooltip");
	}
	...
	public boolean equalsModelElement(ModelElement element) {
		...
		if (!(element instanceof ModelElementTransportDestination)) return false;
		return true;
	}
	...
	public void copyDataFrom(ModelElement element) {
		...
		if (element instanceof ModelElementTransportDestination) {
			if (((ModelElementTransportDestination)element).connection!=null) connectionId=((ModelElementTransportDestination)element).connection.getId();
		}
	}
	 ...
	 */
	@Override
	public ModelElementTransportDestination clone(final EditModel model, final ModelSurface surface) {
		final ModelElementTransportDestination element=new ModelElementTransportDestination(model,surface);
	...
	public String getContextMenuElementName() {
		if (connection==null) return Language.tr("Surface.TransportDestination.Name")+" - "+Language.tr("Surface.TransportDestination.NotConnected");
	...
	public Runnable getProperties(final Component owner, final boolean readOnly, final ModelClientData clientData, final ModelSequences sequences) {
		return ()->{
			new ModelElementTransportDestinationDialog(owner,ModelElementTransportDestination.this,readOnly);
		};
	}
	...
	public String[] getXMLNodeNames() {
		return Language.trAll("Surface.TransportDestination.XML.Root");
	}
	...
	public String getHelpPageName() {
		return "ModelElementTransportDestination";
	}
