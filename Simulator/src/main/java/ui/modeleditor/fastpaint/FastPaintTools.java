...
/**
 * Tools zum Zeichnen der Stationen auf der Zeichenoberfläche.<br>
 * Diese Klasse kann nicht instanziert werden und enthält nur
 * ststische Methoden.
...
public class FastPaintTools {
	...
	/**
	 * Überträgt die Maße aus einem Rechteck in ein anderes ohne
