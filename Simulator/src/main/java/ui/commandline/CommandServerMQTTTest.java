...
/**
 * Startet einen Test-MQTT-Server.
 * @author Alexander Herzog
 * @see AbstractCommand
 * @see CommandLineSystem
 */
public class CommandServerMQTTTest extends AbstractCommand {
	...
	public String getShortDescription() {
		return Language.tr("CommandLine.ServerMQTTTest.Description.Short");
	}

	@Override
	public String[] getLongDescription() {
		return Language.tr("CommandLine.ServerMQTTTest.Description.Long").split("\n");
	}
	...
	public void run(AbstractCommand[] allCommands, InputStream in, PrintStream out) {
		...
		server.stop();
		if (out!=null) out.println(Language.tr("CommandLine.ServerMQTTTest.Stopped"));
	}
