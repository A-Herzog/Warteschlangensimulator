...
public class ModelGeneratorPanel extends JPanel {
	...
	public EditModel getModel() {
		...
		if (addVisualization) {
			...
			add(dummy);
			model.surface.drawToGraphics(dummy.getGraphics(),new Rectangle(1000,1000),1.0,false,false,ModelSurface.Grid.OFF,new Color[] {Color.GRAY,Color.WHITE},null,null,1.0,false);
			remove(dummy);
