...
public class InfoPanel {
	...
	/** Info-ID für den "Duplizieren und teleportieren"-Bearbeiten-Dialog (Gruppe "Transport") */
	public static final String stationTeleportSourceMulti=groupElement+"TeleportSourceMulti";

	/** Info-ID für den "Verzweigen und teleportieren"-Bearbeiten-Dialog (Gruppe "Verzweigungen") */
	public static final String stationDecideAndTeleport=groupElement+"DecideAndTeleport";
	...
	/** Info-ID für den "Tabelle"-Bearbeiten-Dialog (Gruppe "Animation") */
	public static final String stationAnimationTable=groupElement+"AnimationTable";
	...
	private void registerInfos() {
		...
		register(stationDecideAndTeleport,
				()->Language.tr("HintsDialog.TreeNodeStations")+"|"+ModelElementCatalog.GROUP_TRANSPORT+"|"+Language.tr("Surface.DecideAndTeleport.Name"),
				()->Language.tr("Surface.DecideAndTeleport.Infotext"));
		...
		register(stationAnimationTable,
				()->Language.tr("HintsDialog.TreeNodeStations")+"|"+ModelElementCatalog.GROUP_ANIMATION+"|"+Language.tr("Surface.AnimationTable.Name"),
				()->Language.tr("Surface.AnimationTable.Infotext"));
	...
	/**
	 * Zuletzt erzeugtes Textfeld.
	 * @see #getLastPanelLinesCount()
	 * @see #getLinesCountIntern()
	 */
	...
	/**
	 * Liefert die Anzahl an angezeigten Zeilen in dem letzten erzeugten Panel.
	 * @return	Anzahl an angezeigten Zeilen in dem letzten erzeugten Panel
	 */
	public int getLinesCountIntern() {
		if (pane==null) return 0;

		int totalCharacters=pane.getText().length();
	 ...
	 * @return	Anzahl an angezeigten Zeilen in dem letzten erzeugten Panel
	 */
	public static int getLastPanelLinesCount() {
		return getInstance().getLinesCountIntern();
	}
