...
public class ScriptPopup {
	...
	private void buildClients(final ScriptPopupItemSub parent) {
		...
		group.addChild(new ScriptPopupItemCommand(Language.tr("ScriptPopup.Clients.clientData"),Language.tr("ScriptPopup.Clients.clientData.Hint"),null,clientsData));
		group.addChild(new ScriptPopupItemCommand(Language.tr("ScriptPopup.Clients.clientTextData"),Language.tr("ScriptPopup.Clients.clientTextData.Hint"),null,clientsTextData));
