...
public class ExpressionBuilderBasics {
	...
	public static void build(final DefaultMutableTreeNode root, final List<TreePath> pathsToOpen, final String filterUpper) {
		...
		addTreeNode(sub,filterUpper,Language.tr("ExpressionBuilder.TrigonometricFunctions.SinusHyperbolicusReciprocal")+" (csch)","csch("+value+")",Language.tr("ExpressionBuilder.TrigonometricFunctions.SinusHyperbolicusReciprocal.Info"));
		...
		addTreeNode(sub,filterUpper,Language.tr("ExpressionBuilder.TrigonometricFunctions.CosinusHyperbolicusReciprocal")+" (sech)","sech("+value+")",Language.tr("ExpressionBuilder.TrigonometricFunctions.CosinusHyperbolicusReciprocal.Info"));
