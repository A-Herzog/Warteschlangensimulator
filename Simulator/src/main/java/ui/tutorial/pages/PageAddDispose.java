...
/**
 * Tutorial-Seite: Ausgang hinzufügen
 * @author Alexander Herzog
 * @see TutorialPage
 * @see TutorialWindow
 */
public class PageAddDispose implements TutorialPage {
	/**
	 * Konstruktor der Klasse
	 */
	public PageAddDispose() {
		/*
	...
	public String checkNextCondition(MainPanel mainPanel) {
		...
		if (TutorialTools.hasDispose(mainPanel)) return new PageOpenConnect().getPageName();
		return null;
	}
}
